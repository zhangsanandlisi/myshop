...
<!--                //1-->
                <?php
                   foreach (\backend\models\GoodsCategory::find()->where(['parent_id'=>0])->all() as $k1=>$v1):
                ?>
...
<!--                        //2-->
                       <?php
                       foreach (\backend\models\GoodsCategory::find()->where(['parent_id'=>$v1->id])->all() as $k2=>$v2):
                           ?>
...
<!--                             //3-->
                           <?php
                           foreach (\backend\models\GoodsCategory::find()->where(['parent_id'=>$v2->id])->all() as $k3=>$v3):
                               ?>
