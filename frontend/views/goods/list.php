		...
		<div class="list_bd fl ml10 mt10">
			...
			<div class="goodslist mt10">
				<ul>
					...
					<li>
						<dl>
							<dt><a href="<?=\yii\helpers\Url::to(['detail','id'=>$good->id])?>"><img src="<?=$good->logo?>" alt="" /></a></dt>
							<dd><a href="<?=\yii\helpers\Url::to(['detail','id'=>$good->id])?>"><?=$good->name?></a></dt>
							<dd><strong>￥<?=$good->price?></strong></dt>
							<dd><a href="<?=\yii\helpers\Url::to(['detail','id'=>$good->id])?>"><em>已有<?=rand(10000,99999)?>人评价</em></a></dt>
						</dl>
					</li>
                    <?php
                    endforeach;
