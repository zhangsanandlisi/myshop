		...
		<div class="goods_content fl mt10 ml10">
			...
			<div class="summary">
				...
				<div class="preview fl">
					<div class="midpic">
						<a href="<?=$model->imgs[0]->path."?imageView2/2/w/800/h/800"?>" class="jqzoom" rel="gal1">   <!-- 第一幅图片的大图 class 和 rel属性不能更改 -->
							<img src="<?=$model->imgs[0]->path."?imageView2/2/w/350/h/350"?>" alt="" />               <!-- 第一幅图片的中图 -->
						</a>
					</div>
...
<!--						<li class="market_price"><span>定价：</span><em>￥6399.00</em></li>-->
						<li class="shop_price"><span>本店价：</span> <strong>￥<?=$model->price?></strong> <a href="/">(降价通知)</a></li>
						<li><span>上架时间：</span><?=date("Ymd H:i:s",$model->create_time)?></li>
